...
@RestController("lang.variable.Exam4")//클래스 이름이 같은 경우 충돌방지
@RequestMapping("/lang/variable/exam4")
public class Exam4 {


  // 테스트 :
  // => /static/lang/literal/vairable/exam4/test1.html
  @GetMapping("/test1")
  public String test1(int v1, int v2, String op) {
    ...
    //이렇게 서버에서 웹브라우자 출력할 화면을
    //HTML로 만들어 보내는 것을 
    //"서버측 렝더링(sercer-sid rendering)"이라 부른다. 
  ...
  //테스트 :
  // => /static/lang/literal/vairable/exam4/test2.html
  @GetMapping("/test2")
