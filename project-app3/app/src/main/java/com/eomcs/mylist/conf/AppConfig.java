...
// => 스프링 Ioc 컨테이너는 패키지를 뒤져서 @Componet @Controller @Service @RestController @Mapper등이
...
// 2) DB관련 설정의 할 때 DBMS 정보를 담은 properties 파일을 로딩한다. 
@PropertySource("classpath:com/eomcs/spring/ioc/ex12/jdbc.properties")
public class AppConfig {

  @Bean // Spring IoC 컨테이너에게 다음 메서드를 실행 한 후 리턴된 객체를 보관하라는 명령이다. 
