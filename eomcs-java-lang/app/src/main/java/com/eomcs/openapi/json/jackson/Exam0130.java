...
public class Exam0130 {
  public static void main(String[] args) throws Exception{
    ...
    // 1) JSON 문자열 준비
    String jsonStr = "{\"no\":100,\"name\":\"홍길동\",\"email\":\"hong@test.com\",\"password\":\"1111\",\"photo\":\"hong.gif\",\"tel\":\"010-2222-1111\",\"registeredDate\":1642991112901}";
    ...
    // @JsonIgnoreProperties @를 사용하여 JSON 프로퍼티 중에서 무시할 항목을 지정해야 한다. 
    // 
    //
