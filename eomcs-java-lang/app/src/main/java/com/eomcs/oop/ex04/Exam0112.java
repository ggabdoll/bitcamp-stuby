...
public class Exam0112 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    byte[] bytes = {
        (byte)0xb0, (byte)0xa1, // 가 (EUC-KR)
        (byte)0xb0, (byte)0xa2, // 각 (EUC-KR)
        (byte)0xb6, (byte)0xca, // 똘 (EUC-KR)
        (byte)0xb6, (byte)0xcb  // 똥 (EUC-KR)
    };
    String s1 = new String(bytes);
    // 바이트 뱅ㄹ에 들어 있는 문자 코드가 어떤 문자집합에 맞춰 작성되었는지 알려주지 않으면
    ...
    //    이클립스에서 실행 할 경우 : OS에 상관없이 UTF-8 이라고 가정한다.
